...
void KalmanFilter::predictionStep(double dt)
{
    if (!isInitialised() && INIT_ON_FIRST_PREDICTION)
    {
        ...
        // You can use the constants: INIT_POS_STD, INIT_VEL_STD
        // ----------------------------------------------------------------------- //
    ...
    if (isInitialised())
    {
        ...
        // section below.
        // You can use the constants: ACCEL_STD
        // ----------------------------------------------------------------------- //
        // 
...
void KalmanFilter::handleGPSMeasurement(GPSMeasurement meas)
{
    if (isInitialised())
    {
        ...
        // You can use the constants: GPS_POS_STD
        // ----------------------------------------------------------------------- //
        //  
    ...
    else
    {
        ...
        // Assume the state vector has the form [X,Y,VX,VY].
        // You can use the constants: GPS_POS_STD, INIT_VEL_STD
        // ----------------------------------------------------------------------- //
        // 
        VectorXd state = Vector4d::Zero();
        MatrixXd cov = Matrix4d::Zero();
