...
void KalmanFilter::handleLidarMeasurement(LidarMeasurement meas, const BeaconMap& map)
{
    if (isInitialised())
    {
        ...
        //   You can use the constants: LIDAR_RANGE_STD, LIDAR_THETA_STD
...
void KalmanFilter::predictionStep(GyroMeasurement gyro, double dt)
{
    if (isInitialised())
    {
        ...
        //   You can use the constants: ACCEL_STD, GYRO_STD
        //   Use the normaliseState() function to always keep angle values within correct range.
        //   Do NOT normalise during sigma point calculation!
        // ----------------------------------------------------------------------- //
        // 
